      ...
      <div className="min-h-screen bg-gray-50 flex flex-col">
        ...
        <main className="flex-1 flex items-center justify-center p-6">
          <div className="w-full max-w-md">
            ...
            <p className="text-gray-500 text-center mb-8">{t("nameDescription")}</p>
          ...
          <div className="w-full max-w-md space-y-4">
            ...
            >
              ...
              <div className="text-left">
                <span className="block font-semibold text-lg text-gray-900">{t("takeaway")}</span>
                <span className="text-sm text-gray-500">{t("takeawayDesc")}</span>
              </div>
            </button>
            ...
            >
              ...
              <div className="text-left">
                <span className="block font-semibold text-lg text-gray-900">{t("dineIn")}</span>
                <span className="text-sm text-gray-500">{t("dineInDesc")}</span>
              </div>
            </button>
          </div>
        </main>
